...
else
{
	...
	$APPLICATION->IncludeComponent(
		'citfact:crm.construction.show',
		'',
		array(
			'PATH_TO_CONSTRUCTION_SHOW' => $arResult['PATH_TO_CONTACT_SHOW'],
			'PATH_TO_CONSTRUCTION_LIST' => $arResult['PATH_TO_CONTACT_LIST'],
			'PATH_TO_CONSTRUCTION_EDIT' => $arResult['PATH_TO_CONTACT_EDIT'],
			'PATH_TO_CONTACT_SHOW' => $arResult['PATH_TO_CONTACT_SHOW'],
			'PATH_TO_CONTACT_LIST' => $arResult['PATH_TO_CONTACT_LIST'],
			'PATH_TO_CONTACT_EDIT' => $arResult['PATH_TO_CONTACT_EDIT'],
