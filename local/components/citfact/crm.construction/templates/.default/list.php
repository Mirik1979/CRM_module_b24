...
if(!Bitrix\Crm\Integration\Bitrix24Manager::isAccessEnabled(CCrmOwnerType::Construction))
{
...
else
{
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'EXTRAS' => array(),
			'PATH_TO_ENTITY_LIST' => $arResult['PATH_TO_CONSTRUCTION_LIST']
		)
	);
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'PATH_TO_CONSTRUCTION_IMPORTVCARD' => $arResult['PATH_TO_CONSTRUCTION_IMPORTVCARD'],
			'PATH_TO_CONSTRUCTION_DEDUPE' => $arResult['PATH_TO_CONSTRUCTION_DEDUPE'],
			'ELEMENT_ID' => $arResult['VARIABLES']['construction_id'],
			'TYPE' => 'list'
		),
		$component
	);
	...
	if(\Bitrix\Main\ModuleManager::isModuleInstalled('rest'))
	{
		$APPLICATION->IncludeComponent(
			...
			'menu',
			array(
				'PLACEMENT' => "CRM_CONSTRUCTION_LIST_MENU",
				"PLACEMENT_OPTIONS" => array(),
				'INTERFACE_EVENT' => 'onCrmConstructionMenuInterfaceInit',
				'MENU_EVENT_MODULE' => 'crm',
				'MENU_EVENT' => 'onCrmConstructionListItemBuildMenu',
			),
			null,
			array('HIDE_ICONS' => 'Y')
		);
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'PATH_TO_CONSTRUCTION_SHOW' => $arResult['PATH_TO_CONSTRUCTION_SHOW'],
			'PATH_TO_CONSTRUCTION_EDIT' => $arResult['PATH_TO_CONSTRUCTION_EDIT'],
			'PATH_TO_CONSTRUCTION_WIDGET' => $arResult['PATH_TO_CONSTRUCTION_WIDGET'],
