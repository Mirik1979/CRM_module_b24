...
{
	$defaultTitle = GetMessage('CRM_CONSTRUCTION_NAV_TITLE_LIST_SHORT');
	if(empty($defaultTitle))
	{
		$defaultTitle = GetMessage('CRM_CONSTRUCTION_NAV_TITLE_LIST');
	}
	...
	{
		$APPLICATION->AddChainItem($defaultTitle, $arParams['PATH_TO_CONSTRUCTION_LIST']);

		if(isset($arResult['ELEMENT']['~FORMATTED_NAME']))
		{
			$APPLICATION->SetTitle(GetMessage('CRM_CONSTRUCTION_NAV_TITLE_EDIT', array('#NAME#' => $arResult['ELEMENT']['~FORMATTED_NAME'])));
		}
		elseif (isset($arResult['ELEMENT']['ID']))
		{
			$APPLICATION->SetTitle(
				GetMessage(
					'CRM_CONSTRUCTION_NAV_TITLE_EDIT',
					array(
		...
		{
			$APPLICATION->SetTitle(GetMessage('CRM_CONSTRUCTION_NAV_TITLE_ADD'));
		}
	}
	else
	{
