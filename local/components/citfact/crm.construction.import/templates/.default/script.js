...
if(typeof(BX.Crm.ConstructionImportSampleLink) === "undefined")
{
	BX.Crm.ConstructionImportSampleLink = function ()
	{
		this._id = "";
		this._settings = {};
	};
	BX.Crm.ConstructionImportSampleLink.prototype = {
		initialize: function(id, settings)
		{
	...
	BX.Crm.ConstructionImportSampleLink.items = {};
	BX.Crm.ConstructionImportSampleLink.create = function(id, settings)
	{
		var self = new BX.Crm.ConstructionImportSampleLink();
		self.initialize(id, settings);
		BX.Crm.ConstructionImportSampleLink.items[id] = self;
		return self;
	};
	BX.Crm.ConstructionImportSampleLink.delete = function(id)
	{
		if (BX.Crm.ConstructionImportSampleLink.items.hasOwnProperty(id))
		{
			BX.Crm.ConstructionImportSampleLink.items[id].destroy();
			delete BX.Crm.ConstructionImportSampleLink.items[id];
		}
	};
}
