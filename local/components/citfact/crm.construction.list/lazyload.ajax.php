...
if(($ID > 0 && !CCrmConstruction::CheckReadPermission($ID, $userPermissions))
...
$ajaxLoaderParams = array(
	'url' => '/local/components/citfact/crm.construction.list/lazyload.ajax.php?&site='.SITE_ID.'&'.bitrix_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
...
$APPLICATION->IncludeComponent('citfact:crm.construction.list',
