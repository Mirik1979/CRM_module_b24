...
if($communicationPanel)
{
		...
		<div class="crm-entity-actions-container">
			<?if((!$enableCall || empty($phones)) && $USER->isAdmin())
			{
			...
			<?if(empty($messengers) && $USER->isAdmin())
			{
...
if($documentButton && $USER->isAdmin())
{
...
foreach($items as $item)
{
	...
	elseif($type == 'bizproc-starter-button' && $USER->isAdmin())
	{
