...
Bitrix\Main\Page\Asset::getInstance()->addJs('/local/components/bitrix/crm.timeline/templates/.default/wcomm.js');

echo '<script type="text/javascript">wcomm_entity_id=' . $arResult['ENTITY_ID'] . ';</script>' 
	...
	BX.ready(
		function()
		{
			...
			BX.message({
				...
				//wcomm {
				"CRM_WCOMM_CREATE_TITLE": '<?=GetMessageJS("CRM_WCOMM_CREATE_TITLE")?>',
				"CRM_WCOMM_CREATE_CALL": '<?=GetMessageJS("CRM_WCOMM_CREATE_CALL")?>',
				"CRM_WCOMM_CREATE_MEETING": '<?=GetMessageJS("CRM_WCOMM_CREATE_MEETING")?>'				
				//} wcomm
