...
if(typeof(BX.CrmHistory) === "undefined")
{
	...
	BX.CrmHistory.prototype.onItemsLoad = function(sender, result)
	{
		...
		var navigation = BX.prop.getObject(result, "HISTORY_NAVIGATION", {});
		...
		if(BX.prop.getString(this._navigation, "OFFSET_TIMESTAMP", "") !== "")
		{
...
if(typeof BX.CrmTimelineCommentEditor === "undefined")
{
	...
	{
		var assets = BX.prop.getObject(BX.prop.getObject(result, "data", {}), "assets", {});
...
if(typeof(BX.CrmScheduleItem) === "undefined")
{
	...
	//wcomm {
	BX.CrmScheduleItem.prototype.thisIsCall = function()
	{
				
		var perms = BX.prop.getObject(this.getAssociatedEntityData(), "PERMISSIONS", {});
				
		return BX.prop.getBoolean(perms, "IS_CALL", false);
	};
	// } wcomm
