...
if($arResult['IFRAME'])
{
    ...
    \Bitrix\Main\Diag\Debug::writeToFile($APPLICATION->GetCurPageParam('', array('IFRAME')), "", "__miros.log");
...
{
    \Bitrix\Main\Diag\Debug::writeToFile("nonframe", "", "__miros.log");
    $controlPanelID = '';
...
elseif($arResult['ENTITY_TYPE_ID'] == 'CRM_STORES')
{
