...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'TABS' => $arResult['TABS'],
		'SERVICE_URL' => '/local/components/wcomm.crmstores/store.details/ajax.php?'.bitrix_sessid_get(),
		'EDITOR' => array(
			'GUID' => "{$guid}_editor",
