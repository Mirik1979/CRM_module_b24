...
{
    \Bitrix\Main\Diag\Debug::writeToFile($_POST, "match2", "__miros.log");
    \Bitrix\Main\Diag\Debug::writeToFile("match2", "match2", "__miros.log");
...
{
    \Bitrix\Main\Diag\Debug::writeToFile($_POST, "match3", "__miros.log");
    \Bitrix\Main\Diag\Debug::writeToFile("match3", "match3", "__miros.log");
...
{
    \Bitrix\Main\Diag\Debug::writeToFile($_POST, "match4", "__miros.log");
    \Bitrix\Main\Diag\Debug::writeToFile("match4", "match4", "__miros.log");
...
{
    \Bitrix\Main\Diag\Debug::writeToFile($_POST, "match5", "__miros.log");
    \Bitrix\Main\Diag\Debug::writeToFile("match5", "match5", "__miros.log");
...
elseif($action === 'MERGE')
{
    \Bitrix\Main\Diag\Debug::writeToFile($_POST, "match6", "__miros.log");
    \Bitrix\Main\Diag\Debug::writeToFile("match6", "match6", "__miros.log");
...
{
    \Bitrix\Main\Diag\Debug::writeToFile($_POST, "match7", "__miros.log");
    \Bitrix\Main\Diag\Debug::writeToFile("match7", "match7", "__miros.log");
